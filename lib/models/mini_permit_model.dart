...
MiniPermitModel miniPermitModelFromJson(String str) =>
    MiniPermitModel.fromJson(json.decode(str));

String miniPermitModelToJson(MiniPermitModel data) =>
    json.encode(data.toJson());

class MiniPermitModel {
  String type;
  int id;
  String permitNumber;
  String permitType;
  ...
  factory MiniPermitModel.fromJson(Map<String, dynamic> json) =>
      MiniPermitModel(
        type: json["\u0024type"],
        id: json["id"],
        ...
        expiryDate: DateTime.parse(json["expiryDate"]).toLocal(),
        ...
        status: json["status"],
        statusDate: DateTime.parse(json["statusDate"]).toLocal(),
